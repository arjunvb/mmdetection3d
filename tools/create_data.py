...
from tools.data_converter import iphone_converter as iphone
...
def iphone_data_prep(root_path, info_prefix, version, out_dir, with_plane=False):
    """Prepare data related to Iphone dataset.
